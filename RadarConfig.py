...
class RadarConfig(object):
    ...
    def __init__(self, dz='DZ', zdr='DR', kdp='KD', ldr='LH', rho='RH', hid = 'HID',
        ...
        self.delta = {dz: 10, zdr: 1, kdp: 1, ldr: 5, rho: 0.01, hid: 1,w:1,vr:1}
        ...
        self.ticklabels = {dz: np.arange(0, 90, 10), zdr: np.arange(-1, 4, 1), kdp: np.arange(-0.5, 4.5, 1), 
                ldr: np.arange(-35, -15, 5), rho: np.arange(0.95, 1.01, 0.01), hid: np.append('', self.species),w:np.arange(-25,27.0,1.0),vr:np.arange(-25,27.0,1.0)}
#############################################################################################################
